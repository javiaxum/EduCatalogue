...
export default function ErrorPage() {
    const baseUrl = 'http://localhost:5172/api/'
    ...
    function handleBadGuid() {
        axios.get(baseUrl + 'intitutions/notaguid').catch(err => console.log(err.response));
    }

    function handleValidationError() {
        axios.post(baseUrl + 'institutions', {}).catch(err => setErrors(err));
    }
